...
trait FileManager
{
    public function upload(UploadedFile $file, string $path, string $fileName, string|null $disk = '')
    {
    ...
    public function removeFolder(string $path, string|null $disk = '')
    {
        $pathSite = getPathFolder($path);
        $disk = $disk ?? config('constants.document.disk_document');
    ...
    public function removeTempFile(string $path, string|null $disk = '')
    {
    ...
    public function rename(string $documentPath, string $newDocumentPath, string|null $disk = '')
    {
    ...
    public function download(string $documentPath, string $name, string|null $disk = '')
    {
        $pathSite = getPathFolder($documentPath);
        $disk = $disk ?? config('constants.document.disk_document');
